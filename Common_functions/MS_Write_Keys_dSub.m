function Keys = MS_Write_Keys_dSub(data_dir)
%% MS_Write_Exp_dSub: this will create an Keys file by taking the information from the data files 
...
fprintf('\nSession data appears to be Subject %s, on %s with task: %s\n', subject_id, date_id,  sess_id)

% open the file to write
fid = fopen([full_fname '_Keys.m'], 'w');
