function iv1 = MS_IntersectIV(cfg_in,iv1,iv2)
...
% MvdM 2014-06-24
% 
% Updated by EC 2023-06-07 to remove all extra .usr fields. 
...
usr_fields = fieldnames(iv1.usr); 
for ii = 1:length(usr_fields)
    
    iv1.usr.(usr_fields{ii}) = iv1.usr.(usr_fields{ii})(logical(keep)); 
