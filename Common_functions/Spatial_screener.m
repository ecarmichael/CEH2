...
for iC = 1:10 %length(ms.Binary) % loop through cells
    ...
    % check for MI sig
    if Place_MI >   Place_stats.upper_CI95 % passes MI 95CI of shuffle data
...
%     
    ...
    All_cells.place.MI_sig(iC) = Place_MI_sig;
