function [emp_idx, labels, boxes] = MS_SLEAP_EMP(data_dir, save_dir, boxes, plt_mov)
...
tsd = MS_SLEAP2TSD(lab_list_s, 30, [],conv_f, 0);
...
% c_entries = [1 c_entries]; % add the starting frame for closed arms. 
