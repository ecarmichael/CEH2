function All_cells = Spatial_screener_simple(save_dir)
%% Spatial_screener_simple:  simplified version of Spatial_screener that can just be run within a data dir. 
%
%
%
%    Inputs:
...
for iC = 1:length(ms.Binary) % loop through cells
    ...
    saveas(gcf, [save_dir filesep 'Place_figs' filesep f_info.subject '_' f_info.date '_' f_info.task '_Cell_' num2str(iC)], 'png')
    saveas(gcf, [save_dir filesep 'Place_figs' filesep f_info.subject '_' f_info.date '_' f_info.task '_Cell_' num2str(iC)], 'fig')
    ...
    mkdir([save_dir filesep 'Summary' filesep this_parent filesep this_dir]);
    saveas(gcf, [save_dir filesep 'Summary' filesep  this_parent filesep this_dir filesep 'Cell_' num2str(iC) '_Spatial_info.fig'])
    saveas(gcf, [save_dir filesep 'Summary' filesep  this_parent filesep this_dir filesep 'Cell_' num2str(iC) '_Spatial_info.png'])
    %
