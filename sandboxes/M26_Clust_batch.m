...
% TT1
RunClustBatch('fcTT', {'TT1.ntt'}, 'channelValidity',  [1 1 1 1], 'minClusters', 6, 'maxClusters', 12,...
...
% TT5
RunClustBatch('fcTT', {'TT5.ntt'}, 'channelValidity',  [1 1 0 1], 'minClusters', 6, 'maxClusters', 12,...
    'featuresToCompute',{'feature_Peak','feature_Valley','feature_Energy', 'feature_EnergyD1'}, 'featuresToUse', {'feature_Peak','feature_Valley','feature_Energy', 'feature_EnergyD1'});
...
% 
% TT7
RunClustBatch('fcTT', {'TT7.ntt'}, 'channelValidity',  [0 1 1 1], 'minClusters', 6, 'maxClusters', 12,...
    'featuresToCompute',{'feature_Peak','feature_Valley','feature_Energy', 'feature_EnergyD1'}, 'featuresToUse', {'feature_Peak','feature_Valley','feature_Energy', 'feature_EnergyD1'});
