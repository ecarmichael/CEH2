...
csc_idx = [13]; 
swr_ch = 1; 
save_name = 'HF1b2_TFC_D4'; 
TTL = {'6', '7'};



%% HF2b2_TFC3
evts_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H2b2/TFC_D3/HF2b2_2026-01-21_15-20-49_TFC_D3/Record Node 112/experiment1/recording1/events/Intan_RHD_USB-108.Rhythm Data/TTL';
csc_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H2b2/TFC_D3/HF2b2_2026-01-21_15-20-49_TFC_D3/Record Node 117'; 
phy_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H2b2/TFC_D3/HF2b2_2026-01-21_15-20-49_TFC_D3/kilosort4';
vr_fname = ''; 
csc_idx = [13]; 
swr_ch = 1; 
save_name = 'HF2b2_TFC_D3'; 
TTL = {'6', '7'};



%% HF3b2_TFC3
evts_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H3b2/TFC_D3/HF3b2_2026-01-21_17-29-55_TFC_D3/Record Node 112/experiment1/recording1/events/Intan_RHD_USB-108.Rhythm Data/TTL';
csc_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H3b2/TFC_D3/HF3b2_2026-01-21_17-29-55_TFC_D3/Record Node 117'; 
phy_dir = '/Williams Lab Dropbox/Williams Lab Team Folder/Eric/Wheel/TFC/H3b2/TFC_D3/kilosort4';
vr_fname = ''; 
csc_idx = [13]; 
swr_ch = 1; 
save_name = 'HF3b2_TFC_D3'; 
TTL = {'6', '7'};
...
for ii  = size(data.csc.data, 1):-1:1
    ...
    plot(csc_f.tvec, (csc_f.data(ii,:)*5)+(offset*ii));
