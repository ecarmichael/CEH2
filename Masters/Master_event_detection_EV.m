...
%     PARAMS.data_dir = '/home/ecarmichael/Documents/Williams_Lab/Raw_data/JC/7_12_2019_PV1069_LTD5'; % where to find the raw data
    ...
    PARAMS.data_dir = 'J:\Williams_Lab\EV_testcalcium'; % where to find the raw data
    PARAMS.raw_data_dir = 'J:\Williams_Lab\EV_testcalcium'; % raw data location.
    PARAMS.csc_data_dir = 'J:\Williams_Lab\EV_testcalcium'; % where are the LFP files. If blank will look in the same folder as raw_data.
