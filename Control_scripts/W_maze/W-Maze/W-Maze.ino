...
void setup()
{
  ...
  pinMode(solenoidPin_C, OUTPUT); // Sets the pin as an output
...
void loop()
{
  ...
  if (STATE == 3 && R_STATE == 0)
  {
    ...
    nTrials++;
    Serial.print("Correct Inbounds: ");
    Serial.println(nInbound);
    Serial.println("/");
