...
for iB = length(A_in):-1:1
    ...
    [A_in{ii}.pREM_wake_P_loc] = MS_Asmbly_act_loc(A_in{ii}.REM_Wake_proj, A_in{ii}.wake_tvec, A_in{ii}.behav, win_s, thresh, 2/A_in{1}.bins);
